...
Personal Goals
```
Add a simple user login for the ability to relate posts and comments to a specific user and allow for a profile page and deleting their own posts/comments.
```
